...
class MySQLDatabase:
    ...
    def initialize_database(self,database):
        ...
        INSERT INTO category(category_name, description, creation_date, user_ID)
        VALUES ('Sport', 'Sport', '2023-03-10 00:00:00', 99);
        INSERT INTO category(category_name, description, creation_date, user_ID)
        VALUES ('Entertainment', 'Entertainment', '2023-03-10 00:00:00', 99);
        INSERT INTO category(category_name, description, creation_date, user_ID)
        VALUES ('Finance', 'Finance', '2023-03-10 00:00:00', 99);
        INSERT INTO category(category_name, description, creation_date, user_ID)
        VALUES ('Health', 'Health', '2023-03-10 00:00:00', 99);
        INSERT INTO category(category_name, description, creation_date, user_ID)
        VALUES ('Work', 'Work', '2023-03-10 00:00:00', 99);
        INSERT INTO category(category_name, description, creation_date, user_ID)
        VALUES ('Food', 'Food', '2023-03-10 00:00:00', 99);
        INSERT INTO category(category_name, description, creation_date, user_ID)
        VALUES ('Any', 'Any', '2023-03-10 00:00:00', 99);
        INSERT INTO category(category_name, description, creation_date, user_ID)
        VALUES ('Traveling', 'Traveling', '2023-03-15 10:00:00', 1);
        INSERT INTO category(category_name, description, creation_date, user_ID)
        VALUES ('Studying', 'Studying', '2023-03-15 10:00:00', 1);
        INSERT INTO category(category_name, description, creation_date, user_ID)
        VALUES ('Learning', 'Learning', '2023-03-25 15:00:00', 2);
        INSERT INTO category(category_name, description, creation_date, user_ID)
        VALUES ('Studying', 'Studying', '2023-03-25 15:00:00', 2);
        INSERT INTO category(category_name, description, creation_date, user_ID)
        VALUES ('Learning', 'Learning', '2023-03-26 15:00:00', 3);
        INSERT INTO category(category_name, description, creation_date, user_ID)
        VALUES ('Meditation', 'Meditation', '2023-03-27 16:00:00', 4);
        INSERT INTO category(category_name, description, creation_date, user_ID)
        VALUES ('Social', 'Social', '2023-03-27 16:00:00', 4);
        INSERT INTO category(category_name, description, creation_date, user_ID)
        VALUES ('Social', 'Social', '2023-03-28 20:30:00', 5);
        ...
        # Execute the SQL statenments for initialising of the Database one after another    
        try:
